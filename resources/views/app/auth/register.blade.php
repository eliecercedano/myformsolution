                ...
                <div class="row no-gutters">
                    <div class="col-xl-12">
                        <div class="auth-form">
                            ...
                            @endif
                            <h4 class="text-center mb-4 text-primary"><b>{{trans('auth.register') }}</b></h4>
                            ...
                            <div class="new-account mt-3">
                                <p class="text-primary">{{trans('auth.have_account_already') }}<a class="text-primary" href="{{ url('/login'); }}"><b> {{trans('auth.sign_in') }}</b></a></p>
                            </div>
                        </div>
                    </div>
                </div>
