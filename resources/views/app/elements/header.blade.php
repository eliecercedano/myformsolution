            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <div class="dashboard_bar">
                      @yield('title', trans('header.'.$page_title) ?? 'Dashboard')
                    </div>
                </div>
                ...
                <!--li class="nav-item dropdown header-profile">
                  <div class="header-info"-->
                    <span class="text-black">
                      {{--trans('auth.select_language')--}}
                      <!--a href="{ {route('language','es')}}" class="{ {request()}}"-->
                      <a href="{{route('language','es')}}" class="">
                        <img class="btn-languaje" src="{{ asset('icons/flags-icons/es.svg') }}" height="20" style="margin-top: 3rem; margin-left:1rem;">
                        <span class="ml-2">{{--trans('auth.es')--}} </span>
                      </a>
                    </span>
                  <!--/div>
                </li>
                <li class="nav-item header-profile">
                  <div class="header-info"-->
                    <span class="text-black">
                       {{--trans('auth.select_language')--}}
                       <a href="{{route('language','en')}}" class="">
                        <img class="btn-languaje" src="{{ asset('icons/flags-icons/en.svg') }}" height="20" style="margin-top: 3rem; margin-left:1rem;">
                        <span class="ml-2">{{--trans('auth.en')--}}</span>
                      </a>
                    </span>
                  <!--/div>
                </li-->
                <li class="nav-item dropdown header-profile">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                      <a href="{{ url('index/profile'); }}" class="dropdown-item ai-icon">
                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                        <span class="ml-2">{{trans('profile.profile')}}</span>
                      </a>
                      @if($role[0] == 'Consultor')
                        <!--a href="{ { route('invitation.index') }}" class="dropdown-item ai-icon"-->
                        <a href="#" class="dropdown-item ai-icon">
                          <i class="flaticon-381-id-card-1"></i>
                          <span class="ml-2">{{trans('profile.invitations')}} </span>
                        </a>
                      @endif
                      <a href="{{ url('/subscription'); }}" class="dropdown-item ai-icon">
                        <i class="fa fa-credit-card"></i>
                        <span class="ml-2">{{trans('profile.subscription')}}: {{ typeSubscription(  Session::get('info_subscription')->product_id ) }} </span>
                      </a>
                      <a href="{{ url('/email-inbox'); }}" class="dropdown-item ai-icon">
                        <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                        <span class="ml-2">{{trans('profile.inbox')}}</span>
                      </a>
                      <a href="{{ route('logout') }}" class="dropdown-item ai-icon" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        ...
                        <span class="ml-2">{{trans('profile.logout')}} </span>
