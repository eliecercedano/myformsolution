    ...
    <div class="sabana">
        ...
        <div class="text mt-2" style="margin-top:2.5rem;">
            ...
            <div>
                ...
                <div class="cell cell-b mt-1" style="float:center; margin-left:5%; width:2.5%;">&nbsp;</div>
                <div class="cell cell-m mt-1" style="float:center; margin-left:7.5%; width:2.5%;">&nbsp;</div>
                <div class="cell cell-m mt-1" style="float:center; margin-left:10%; width:2.5%;">&nbsp;</div>
                <div class="cell cell-m mt-1" style="float:center; margin-left:12.5%; width:2.5%;">&nbsp;</div>
                <div class="cell cell-m mt-1" style="float:center; margin-left:15%; width:2.5%;">&nbsp;</div>
                <div class="cell cell-m mt-1" style="float:center; margin-left:17.5%; width:2.5%;">&nbsp;</div>
                <div class="cell cell-m mt-1" style="float:center; margin-left:20%; width:2.5%;">&nbsp;</div>
                <div class="cell cell-m mt-1" style="float:center; margin-left:22.5%; width:2.5%;">&nbsp;</div>
                <div class="cell cell-e mt-1" style="margin-left:25%; width:2.5%;">&nbsp;</div>
                <!--div class="" style="margin-left:5%; width:28%;">
                    <input type="text" class="inputs">
                </div-->
            </div>
        </div>
